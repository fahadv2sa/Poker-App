...
function RoomCard({ r }: { r: RoomCardData }) {
  ...
  const href = isPublic ? "/games/top-10/play" : r.code ? `/games/top-10/play?join=${encodeURIComponent(r.code)}` : "/games/top-10/play";
 ...
 *  matchmaking-only and deliberately never listed — quick play is entered from
 *  its own button, not the browser. */
