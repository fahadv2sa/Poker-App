 ...
 *  their PUBLIC number so the Top Ten table's seats can show avatars without
 *  exposing user ids. Mirrors Link Up's route (shared platform users). 404 when
 *  none uploaded → the seat falls back to a generated avatar. */
