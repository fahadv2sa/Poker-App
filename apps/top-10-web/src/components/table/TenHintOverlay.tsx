      ...
      <AnimatePresence>
        {flash ? (
          <motion.div
            ...
            className="rounded-2xl border border-[var(--lu-ember)]/70 bg-[#0b0908]/90 px-7 py-4 text-center shadow-[0_0_30px_rgba(255,106,26,0.5)] backdrop-blur"
          >
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="max-w-[88vw] rounded-2xl border border-[var(--lu-ember)]/50 bg-[#0b0908]/85 px-6 py-3 text-center shadow-xl backdrop-blur"
          >
            <div className="text-[0.66rem] font-bold tracking-[0.18em] text-[var(--lu-ember-glow)]">تلميح · الأسرع يفوز</div>
